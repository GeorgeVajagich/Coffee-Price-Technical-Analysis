...
```{r}
cor(df$past_five_years_performance, df$next_five_years_performance, use = "complete.obs")
ggplot(df, aes(x=past_five_years_performance, y=next_five_years_performance)) + geom_point(size=0.5) + theme(aspect.ratio=1)
```